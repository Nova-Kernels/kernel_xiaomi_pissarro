...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   := -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -g0 \
		-ftree-vectorize -funroll-loops -finline-functions -fomit-frame-pointer -std=gnu89 $(HOST_LFS_CFLAGS)
HOSTCXXFLAGS := -O3 -g0 -ftree-vectorize -funroll-loops -finline-functions $(HOST_LFS_CFLAGS)
HOSTLDFLAGS  := -O3 -flto $(HOST_LFS_LDFLAGS)
